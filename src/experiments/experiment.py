...
class Experiment:
    ...
    def __init__(self,
        ...
        self.fairshap_base = 'DR'   # combine FairSHAP with DR
    ...
    def run(self, ith_fold: int):
        ...
        df.loc[-1] = ["original", original_DR, original_DP, original_EO, original_PQP]  # 插入到第一行
        ...
        # 生成 CSV 文件名
        csv_filename = f"{self.ith_fold}-fold_results.csv"
